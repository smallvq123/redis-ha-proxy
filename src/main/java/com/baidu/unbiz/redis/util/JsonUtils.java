...
public class JsonUtils {
    ...
    public static final class IosDateTimeJsonSerializer extends JsonSerializer<Date> {
        ...
        @Override
        public void serialize(Date value, JsonGenerator paramJsonGenerator, SerializerProvider provider)
                throws IOException, JsonProcessingException {
            if (value != null) {
                paramJsonGenerator.writeString(ISO_DATETIME_FORMAT.format(value));
            }
        }
